...
var getBeersApi = function getBeersApi() {
  return fetch('https://api.punkapi.com/v2/beers').then(function (response) {
    ...
    var tagHtml = "<table>" + "<tr>" + "<th>Image</th>" + "<th>Name</th>" + "<th>Tagline</th>" + "<th>First Brewed</th>" + "<th>Description</th>" + "</tr>";
    for (var i = 0; i < length; i++) {
      tagHtml += "<tr>" + "<td style='text-align:center;'><image src=" + beers[i].image_url + " height='200px;'/></td>" + "<td>" + beers[i].name + "</td>" + "<td>" + beers[i].tagline + "</td>" + "<td>" + beers[i].first_brewed + "</td>" + "<td>" + beers[i].description + "</td>" + "</tr>";
    }
    tagHtml += "</html>";
...
var searchBeers = function searchBeers() {
  return fetch('https://api.punkapi.com/v2/beers').then(function (response) {
    ...
    for (var i = 0; i < length; i++) {
      ...
      //console.log('res :',res);
      if (res) {
        tagHtml += "<tr>" + "<td style='text-align:center;'><image src=" + beers[i].image_url + " height='200px;'/></td>" + "<td id='value'>" + beers[i].name + "</td>" + "<td id='value'>" + beers[i].tagline + "</td>" + "<td id='value'>" + beers[i].first_brewed + "</td>" + "<td id='value'>" + beers[i].description + "</td>" + "</tr>";
      }
    }
    tagHtml += "</html>";
    //console.log('Tag HTML',response);
